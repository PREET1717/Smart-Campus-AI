    ...
    async (req, res) => {
        ...
        try {
            ...
            if (
                ...
                let reply =
                    `Aapki total ${complaints.length} complaints hain:\n\n`;
            ...
            if (
                ...
                const complaints =
                    await supabaseFetch(
                        "complaints",
                        `?user_id=eq.${encodeURIComponent(userId)}&order=created_at.desc&limit=1`
                    );
                ...
                return res.json({
                    ...
                    reply:
                        `Aapki latest complaint ka status: ${complaint.status || "N/A"}\n\n` +
                        `Complaint: ${complaint.complaint_text || "N/A"}\n` +
            ...
            if (
                ...
                if (
                    ...
                    return res.json({
                        success: true,
                        reply:
                            "Abhi koi upcoming event available nahi hai."
                    });
            ...
            if (
                ...
                if (
                    ...
                    return res.json({
                        success: true,
                        reply:
                            "Lost & Found mein abhi koi item nahi hai."
                    });
            ...
            return res.status(500).json({
                ...
                reply:
                    "Assistant server mein error aa gaya.",
